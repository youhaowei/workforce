...
describe('filterSessions', () => {
  const sessions: SessionSummary[] = [
    ...
    makeSession({ id: '2', title: 'Beta agent', metadata: { type: 'workagent', goal: 'deploy service' } }),
    makeSession({
      id: '3',
      title: 'Gamma',
...
describe('groupSessions', () => {
  ...
  const projectMap = new Map<string, Project>([
    ['proj_a', { id: 'proj_a', orgId: 'org1', name: 'Project A', rootPath: '/a', color: '#E57373', createdAt: 0, updatedAt: 0 }],
    ['proj_b', { id: 'proj_b', orgId: 'org1', name: 'Project B', rootPath: '/b', color: '#81C784', createdAt: 0, updatedAt: 0 }],
  ]);
