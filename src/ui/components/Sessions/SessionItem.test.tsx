...
describe("SessionItem", () => {
  ...
  it("renders Untitled Session when no title", () => {
    render(<SessionItem session={{ ...baseSession, title: undefined }} />);
  ...
  it("calls onSelect when clicked", () => {
    render(<SessionItem session={baseSession} onSelect={mockOnSelect} />);
  ...
  it("shows Delete button", () => {
    render(<SessionItem session={baseSession} onDelete={mockOnDelete} />);
  ...
  it("does not call onSelect when Enter is pressed on Delete button", () => {
    render(<SessionItem session={baseSession} onSelect={mockOnSelect} onDelete={mockOnDelete} />);
