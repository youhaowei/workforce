...
const Surface = React.forwardRef<HTMLDivElement, SurfaceProps>(
  ({ className, variant, ...props }, ref) => {
    ...
    const variantClass = variant ? (isDesktop ? desktopVariants : webVariants)[variant] : undefined;
    return <div ref={ref} className={cn(baseClasses, variantClass, className)} {...props} />;
  },
);
