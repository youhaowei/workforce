 ...
 * Git router tests.
 *
 * Since the git router creates per-request GitService instances (no singleton),
 * we test the service layer directly with a real temp git repo.
 * This validates the same code paths the router uses.
 */
